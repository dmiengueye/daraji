   ...
   //Tutor must be approved in the subject prior to applying for any job in subject
                                  ...
                                  )))))
      {
       ...
       if(empty($tutor_profile) )  {
         $this->Session->setFlash(
								 sprintf(__d('users', 'Please 1 Complete Your Profile before applying for Jobs')),
						         'default',
								  array('class' => 'alert alert-warning')
							   );
        return $this->redirect(array('action' => 'manage_basic_profile'));
         ...
         $this->Session->setFlash(
								 sprintf(__d('users', 'Please 2 Complete Your Basic Profile before applying for Jobs')),
						         'default',
								  array('class' => 'alert alert-warning')
							   );
        return $this->redirect(array('action' => 'manage_basic_profile'));
         ...
         {
         $this->Session->setFlash(
								 sprintf(__d('users', 'Please 3 Complete Your Public Profile before applying for Jobs')),
						         'default',
								  array('class' => 'alert alert-warning')
							   );
