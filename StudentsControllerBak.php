...
protected function _setupAuth() {
		...
		$this->Auth->allow(
					       'login', 'register', 'joinus', 'index', 'jobsearchresults', 'aboutus','add',
...
**/
  ...
  */
 	public function add() {
         ...
         // debug($this->request->data[$this->modelClass]);
 		...
 		if ($this->Auth->user()) {
 		 ...
 		 if(
 	        (isset($this->request->data[$this->modelClass]['userType']) )  &&
 	        (!empty($this->request->data[$this->modelClass]['userType']))
 	     ) {
 	        if( ($this->request->data[$this->modelClass]['userType'] == 'student') ||
 	            ($this->request->data[$this->modelClass]['userType'] == 'Student')
 	          )
 	        {
 	            $userst = $this->request->data[$this->modelClass]['userType'];
 	        }
 	    }if (!empty($this->request->data)) {


 			$student = $this->{$this->modelClass}->register($this->request->data, false,  strtolower($userst));
 			if ($student !== false) {
 				$Event = new CakeEvent(
