...
/** Hide these for now b/c of wyzant **/
public function student_reviews_of_wizwonk() {
   $this->layout = 'default';
   if($this->Session->check('commonLayout') ) {
      $this->layout = $this->Session->read('commonLayout');
   }
...
public function tutor_reviews_of_wizwonk() {
    $this->layout = 'default';
   if($this->Session->check('commonLayout') ) {
      $this->layout = $this->Session->read('commonLayout');
   }
...
public function student_reviews_of_tutors() {
    $this->layout = 'default';
   if($this->Session->check('commonLayout') ) {
      $this->layout = $this->Session->read('commonLayout');
   }
...
public function tutoring_safety() {
    $this->layout = 'default';
   if($this->Session->check('commonLayout') ) {
      $this->layout = $this->Session->read('commonLayout');
   }
...
public function help() {
    ...
    $this->layout = 'help_screen_default';
    $this->set('title_for_layout', 'Help | Daraji Tutoring');
...
public function forgot_email_help() {
...
public function online_tutoring() {
    $this->layout = 'default';
   if($this->Session->check('commonLayout') ) {
      $this->layout = $this->Session->read('commonLayout');
   }
...
public function reset_password_sucess() {
    $this->layout = 'default';
   if($this->Session->check('commonLayout') ) {
      $this->layout = $this->Session->read('commonLayout');
   }
...
public function login() {
      // debug("tete"); die();
       ...
       //$this->layout = 'default';
       //debug($this->request->data[$this->modelClass]); die();
